...
@media(min-width:768px){
  /* Center kicker against the actual СТУДИЯ КОЛОРИСТИКИ ЕЛЕНЫ БАГДАСАРЯН text box, not the whole left column. */
  #salonDesktopTop .std-logo{
...
`;
          ...
          <div class="mct-about-card">
            <div class="mct-about-portrait-wrap">
              <figure class="mct-about-portrait">
                <img src="salon3.webp" alt="Студия Колористики Елены Багдасарян" loading="lazy">
  ...
  const DESKTOP_I18N_ROWS=[
    ...
    ['Смотреть все отзывы →','Դիտել բոլոր կարծիքները →','View all reviews →'],['Ждём вас','Սպասում ենք ձեզ','We look forward to seeing you'],['Солнечная ул., 6, Люберцы','Քաղաք, Սրահի հասցե','City, Солнечная ул., 6, Люберцы'],
