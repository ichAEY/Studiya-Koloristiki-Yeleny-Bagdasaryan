...
(function(){
  ...
  if(!window.matchMedia || !window.matchMedia('(max-width:1023px)').matches || window.matchMedia('(min-width:768px) and (hover:hover) and (pointer:fine)').matches) return;
    ...
    @media(max-width:1023px){
      ...
      .tn22-card{position:absolute!important;z-index:8!important;top:343px!important;left:15px!important;right:15px!important;bottom:0!important;height:auto!important;display:flex!important;flex-direction:column!important;padding:19px 20px 18px!important;border-radius:13px 13px 0 0!important;text-align:center!important}
      .tn22-card:after{background:linear-gradient(180deg,rgba(247,242,235,0) 0%,rgba(247,242,235,.54) 48%,#f7f2eb 94%)!important}
      .tn22-title{margin:0!important;font:600 clamp(12px,3.7vw,15px)/1 'Manrope',Arial,sans-serif!important;letter-spacing:.24em!important;text-indent:.24em!important;text-transform:uppercase!important;white-space:nowrap!important;color:#635d58!important}
      .tn22-sub{margin:11px 0 0!important;font:500 clamp(29px,8.6vw,36px)/.96 'Cormorant Garamond',Georgia,serif!important;letter-spacing:.045em!important;text-indent:.045em!important;text-transform:uppercase!important;color:#211d1a!important;white-space:nowrap!important}
      ...
      #tn13Services .tn31-service-list{display:grid!important;gap:10px!important;margin-top:18px!important;border:0!important}
      #tn13Services .tn31-service-row{position:relative!important;display:flex!important;min-height:128px!important;width:100%!important;flex-direction:column!important;align-items:stretch!important;padding:19px 56px 17px 18px!important;border:1px solid rgba(255,255,255,.12)!important;border-radius:16px!important;background:rgba(255,255,255,.045)!important;color:#f7f3f0!important;text-align:left!important;box-shadow:none!important}
      #tn13Services .tn31-service-row:after{content:'↗'!important;position:absolute!important;top:16px!important;right:16px!important;width:34px!important;height:34px!important;display:grid!important;place-items:center!important;border:1px solid rgba(255,255,255,.16)!important;border-radius:50%!important;background:rgba(255,255,255,.055)!important;color:#d8b7aa!important;font:500 14px/1 'Manrope',Arial,sans-serif!important}
      #tn13Services .tn31-service-row:active{transform:translateY(1px)!important;background:rgba(255,255,255,.075)!important}
      #tn13Services .tn31-service-copy{display:block!important;min-width:0!important;padding:0!important}
      #tn13Services .tn31-service-name{display:block!important;color:#f7f3f0!important;font:500 21px/1.08 'Cormorant Garamond',Georgia,serif!important;-webkit-line-clamp:unset!important;overflow:visible!important}
      #tn13Services .tn31-service-detail{display:block!important;margin-top:7px!important;color:#bdbdbd!important;font:400 10px/1.45 'Manrope',Arial,sans-serif!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important}
      #tn13Services .tn31-service-side{display:flex!important;align-items:flex-end!important;justify-content:space-between!important;gap:12px!important;margin-top:auto!important;padding-top:17px!important;text-align:left!important}
      #tn13Services .tn31-service-book{display:inline-flex!important;min-height:25px!important;align-items:center!important;margin:0!important;padding:0 9px!important;border:0!important;border-radius:999px!important;background:rgba(255,255,255,.07)!important;color:#c9bdb6!important;font:500 9px/1 'Manrope',Arial,sans-serif!important}
      #tn13Services .tn31-service-price{color:#f7f3f0!important;font:500 17px/1 'Cormorant Garamond',Georgia,serif!important;white-space:nowrap!important}
    ...
    if(reviewsRoot){
      const REVIEW_URL="https://yandex.ru/maps/org/studiya_koloristiki_yeleny_bagdasaryan/18398312097/";
      ...
      reviewsRoot.innerHTML=`<div class="br-reviews"><p class="tn22-kicker">Отзывы</p><h2>Что говорят о нас</h2><div class="br-score"><strong>5.0</strong><div class="br-stars" aria-label="5 звёзд">★★★★★</div><div class="br-count">165 отзывов · Яндекс Карты</div></div><div class="br-review-viewport"><div class="br-review-track">${loop.map(page).join('')}</div></div><a class="br-review-all" href="${REVIEW_URL}" target="_blank" rel="noopener">Смотреть все отзывы →</a></div>`;
      ...
      const paint=(animate=true,drag=0)=>{
        ...
        track.style.transition=animate?'transform 720ms cubic-bezier(.2,.72,.2,1)':'none';
...
(function(){
  ...
  function applySpecials(){
    ...
    if(heroHours) heroHours.textContent=currentLang==='en'?'Daily 10:00–20:00':'Ежедневно 10:00–20:00';
