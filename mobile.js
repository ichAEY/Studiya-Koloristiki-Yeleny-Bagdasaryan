...
#tn13Services .tn31-service-list{display:grid;gap:9px;margin:18px -12px 0;border:0}
#tn13Services .tn31-service-row{position:relative;display:grid;grid-template-columns:minmax(0,1fr) auto;min-height:60px;width:100%;align-items:center;gap:12px;padding:10px 23px;border:1px solid rgba(255,255,255,.11);border-radius:11px;background:rgba(255,255,255,.055);color:#f7f3f0;text-align:left;box-shadow:none}
