...
const VIEWER_MEDIA=[...new Map([...PORTFOLIO,...ALL_MEDIA].map(item=>[item.src,item])).values()];
...
.tn22-card{position:absolute;z-index:8;top:343px;left:15px;right:15px;bottom:0;height:auto;padding:20px 20px 18px;border-radius:13px 13px 0 0;background:linear-gradient(180deg,rgba(249,246,241,.985) 0%,rgba(249,246,241,.985) 80%,#f7f2eb 100%);box-shadow:0 -2px 18px rgba(47,37,31,.09),0 -1px 4px rgba(47,37,31,.05);text-align:center}.tn22-card:after{content:'';position:absolute;z-index:0;left:-15px;right:-15px;bottom:-1px;height:62px;background:linear-gradient(180deg,rgba(247,242,235,0) 0%,rgba(247,242,235,.5) 48%,#f7f2eb 92%);pointer-events:none}.tn22-card>*{position:relative;z-index:1}.tn22-hero-crown{display:block;width:138px;height:50px;max-width:138px;margin:0 auto 9px;object-fit:contain;object-position:center center;mix-blend-mode:multiply}.tn22-title{display:block;width:calc(100% - 16px);max-width:330px;margin:0 auto;font:500 clamp(24px,7.8vw,31px)/.94 'Cormorant Garamond',Georgia,serif;letter-spacing:.012em;text-indent:0;text-transform:uppercase;white-space:nowrap;text-align:center;overflow:visible}.tn22-sub{display:block;width:calc(100% - 16px);max-width:330px;margin:10px auto 16px;font:500 clamp(18px,5.2vw,21px)/1 'Cormorant Garamond',Georgia,serif;letter-spacing:.06em;text-indent:0;text-transform:uppercase;color:#635d58;white-space:nowrap;text-align:center}.tn22-orn{display:flex;align-items:center;justify-content:center;gap:8px;margin:15px auto 14px;color:#bda388}.tn22-orn:before,.tn22-orn:after{content:'';width:45px;height:1px;background:#bfa589}.tn22-copy{margin:0 auto;width:270px;max-width:100%;font:400 14px/1.38 'Manrope',Arial,sans-serif;color:#33302d}.tn37-hero-info{width:min(100%,330px);margin:18px auto 0;display:grid;grid-template-columns:1fr 1px 1.18fr;align-items:center;gap:12px;text-align:left}.tn37-info-divider{width:1px;height:42px;background:rgba(62,51,44,.13)}.tn37-info{display:grid;grid-template-columns:40px minmax(0,1fr);align-items:center;gap:9px;min-width:0}.tn37-info-icon{width:40px;height:40px;border-radius:50%;display:grid;place-items:center;background:rgba(255,255,255,.52);border:1px solid rgba(62,51,44,.09);box-shadow:0 5px 14px rgba(47,37,31,.05)}.tn37-info-icon svg{width:21px;height:21px;fill:none;stroke:#171513;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.tn37-info-copy{font:400 10.5px/1.28 'Manrope',Arial,sans-serif;color:#282420}.tn37-info-copy strong{display:block;margin-bottom:3px;font:500 11.5px/1.1 'Manrope',Arial,sans-serif;color:#3f8750}.tn37-location .tn37-info-copy strong{color:#282420;font-weight:500}.tn50-hero-status.open .tn50-hero-status-main{color:#3f8750}.tn50-hero-status.closed .tn50-hero-status-main{color:#a45e64}.tn22-cta{position:relative;overflow:hidden;display:flex;width:min(100%,330px);height:50px;margin:18px auto 0;align-items:center;justify-content:center;gap:12px;border:0;border-radius:8px;background:#715b53;color:#fff!important;font:500 14px/1 'Manrope',Arial,sans-serif;transition:transform .14s ease,background .14s ease}.tn22-cta:after{content:'';position:absolute;top:-35%;bottom:-35%;left:-42%;width:34%;background:linear-gradient(90deg,transparent,rgba(255,255,255,.34),transparent);transform:skewX(-20deg);animation:tn54HeroShine 3.2s ease-in-out infinite;pointer-events:none}.tn22-cta:active{transform:translateY(1px) scale(.985);background:#654f48}@keyframes tn54HeroShine{0%,62%{left:-42%}100%{left:132%}}.tn22-cta svg{width:20px;height:20px;fill:none;stroke:currentColor;stroke-width:1.75;stroke-linecap:round;stroke-linejoin:round}.tn22-worklink{display:flex;width:min(100%,330px);height:48px;margin:10px auto 0;align-items:center;justify-content:center;gap:11px;border:1px solid rgba(113,91,83,.42);border-radius:8px;background:rgba(255,255,255,.12);color:#25211f!important;text-decoration:none!important;font:500 13px/1 'Manrope',Arial,sans-serif;transition:transform .14s ease,background .14s ease}.tn22-worklink:active{transform:translateY(1px) scale(.988);background:rgba(113,91,83,.10)}.tn22-worklink svg{width:19px;height:19px;fill:none;stroke:currentColor;stroke-width:1.7;stroke-linecap:round;stroke-linejoin:round}
...
.tn31-services{padding:32px 25px 40px}
...
#tn13Services .tn31-cat{position:relative;flex:0 0 auto;height:35px;padding:0 15px;border:1px solid rgba(255,255,255,.20);border-radius:999px;background:rgba(255,255,255,.03);color:#d2d2d2;font:500 12.6px/1 'Manrope',Arial,sans-serif;white-space:nowrap;transition:transform .14s ease,background .18s ease,color .18s ease,border-color .18s ease,box-shadow .18s ease}
#tn13Services .tn31-cat.active{background:#f7f2eb!important;color:#2f2926!important;border-color:#f7f2eb!important;box-shadow:0 4px 12px rgba(0,0,0,.16)}#tn13Services .tn31-cat:active{transform:translateY(1px) scale(.96)}
#tn13Services .tn31-service-list{display:grid;gap:9px;margin:18px -8px 0;border:0}
#tn13Services .tn31-service-row{position:relative;display:grid;grid-template-columns:minmax(0,1fr) auto;min-height:60px;width:100%;align-items:center;gap:12px;padding:10px 19px;border:1px solid rgba(255,255,255,.11);border-radius:11px;background:rgba(255,255,255,.055);color:#f7f3f0;text-align:left;box-shadow:none}
...
.tn54-reveal-block{opacity:0;transform:translate3d(0,20px,0);transition:opacity .62s ease,transform .68s cubic-bezier(.22,.78,.25,1);will-change:opacity,transform}.tn54-reveal-block.tn54-visible{opacity:1;transform:translate3d(0,0,0)}
#tn13Sticky button{transition:transform .14s ease,background .14s ease!important}#tn13Sticky button:active{transform:translateY(1px) scale(.975)!important}
@media(prefers-reduced-motion:reduce){.tn54-reveal-block{opacity:1!important;transform:none!important;transition:none!important}.tn22-cta:after,#tn13Sticky button:after{animation:none!important}}

#tn13Gallery{display:block!important;z-index:650!important;background:#f7f2eb!important;color:#171513!important;padding:0!important;width:100vw!important;max-width:100vw!important;overflow-x:hidden!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important;overscroll-behavior-x:none!important;overscroll-behavior-y:contain!important;touch-action:pan-y!important;visibility:hidden!important;opacity:0!important;transform:translate3d(0,38px,0)!important;pointer-events:none!important;transition:transform .5s cubic-bezier(.16,1,.3,1),opacity .36s ease,visibility 0s linear .5s!important;will-change:transform,opacity}#tn13Gallery.open{visibility:visible!important;opacity:1!important;transform:translate3d(0,0,0)!important;pointer-events:auto!important;transition-delay:0s!important}#tn13Gallery.closing{visibility:visible!important;opacity:0!important;transform:translate3d(0,26px,0)!important;pointer-events:none!important}.tn22-gallery{width:100%;max-width:100vw;min-height:100dvh;padding:24px 18px 40px;overflow-x:hidden;box-sizing:border-box}.tn22-gallery-top{display:grid;grid-template-columns:44px 1fr 44px;align-items:center}.tn22-gallery-back{width:40px;height:40px;border:0;background:none;font-size:28px}.tn22-gallery-title{text-align:center}.tn22-gallery-title strong{display:block;font:500 42px/.9 'Cormorant Garamond',Georgia,serif;white-space:nowrap}.tn22-gallery-title span{display:block;margin-top:8px;font:500 10px/1 'Manrope',Arial,sans-serif;letter-spacing:.18em;color:#7e746d;white-space:nowrap}.tn22-gallery-tabs{display:flex;gap:0;margin-top:26px;border:1px solid rgba(55,44,39,.12);border-radius:14px;overflow-x:auto;overflow-y:hidden;overscroll-behavior-x:contain;overscroll-behavior-y:none;touch-action:pan-x;-webkit-overflow-scrolling:touch;scrollbar-width:none}.tn22-gallery-tabs::-webkit-scrollbar{display:none}.tn22-gallery-tab{flex:0 0 auto;height:43px;padding:0 18px;border:0;background:transparent;font:500 11px/1 'Manrope',Arial,sans-serif;color:#6f655f}.tn22-gallery-tab.active{background:#171513;color:#fff!important}.tn22-gallery-grid{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:18px;width:100%;min-width:0;overflow:hidden}.tn22-gallery-grid.salon{grid-template-columns:1fr 1fr}.tn22-gallery-tile{border:0;padding:0;overflow:hidden;border-radius:11px;background:#ddd;aspect-ratio:1/1}.tn22-gallery-grid.salon .tn22-gallery-tile{aspect-ratio:1/1}.tn23-gallery-empty{grid-column:1/-1;padding:54px 10px;text-align:center;color:#847a73;font:400 13px/1.5 'Manrope',Arial,sans-serif}.tn22-gallery-tile img,.tn22-gallery-tile video{width:100%;height:100%;object-fit:cover;filter:none!important}.tn22-gallery-tile video{pointer-events:none}
...
function fitHeroTitle(){
  ...
  fitLine(heroTitleEl,Math.min(31,Math.max(24,window.innerWidth*.078)),20);
  fitLine(heroSubEl,Math.min(21,Math.max(18,window.innerWidth*.052)),16);
}
window.__fitSalonHeroTitle=fitHeroTitle;
fitHeroTitle();
if(document.fonts&&document.fonts.ready)document.fonts.ready.then(fitHeroTitle).catch(()=>{});
if('ResizeObserver' in window)new ResizeObserver(fitHeroTitle).observe(heroCardEl);
const heroHeadingObserver=new MutationObserver(fitHeroTitle);
heroHeadingObserver.observe(heroTitleEl,{childList:true,characterData:true,subtree:true});
heroHeadingObserver.observe(heroSubEl,{childList:true,characterData:true,subtree:true});
window.addEventListener('orientationchange',()=>requestAnimationFrame(fitHeroTitle),{passive:true});
...
// REVIEWS — current Esmeralda structure/mechanics, Elena data.
...
const reviewInitial=name=>([...String(name).trim()][0]||'S').toUpperCase();
const reviewCard=r=>`<a class="br-review-card" href="${REVIEW_URL}" target="_blank" rel="noopener"><div class="br-review-head"><span class="br-review-avatar">${reviewInitial(r[0])}</span><span><strong class="br-review-name">${r[0]}</strong><span class="br-review-meta"><span>Яндекс Карты</span><span class="br-review-meta-stars">★★★★★</span></span></span></div><p>${r[1]}</p><span class="br-review-open">Подробнее →</span></a>`;
const reviewGroups=[];
...
reviewViewport.addEventListener('pointerdown',e=>{
  ...
  reviewStartY=e.clientY;
});
reviewViewport.addEventListener('pointermove',e=>{
  if(!reviewDragging)return;
  const x=e.clientX-reviewStartX,y=e.clientY-reviewStartY;
  if(!reviewGestureAxis){
    ...
    reviewCapturedPointer=e.pointerId;
    try{reviewViewport.setPointerCapture(e.pointerId)}catch(_){}
  }
...
(function(){
  ...
  if(!window.matchMedia || !window.matchMedia('(max-width:1023px)').matches || window.matchMedia('(min-width:768px) and (hover:hover) and (pointer:fine)').matches) return;
    ...
    /* One-time section reveal, matching the salon's restrained motion language. */
    const revealBlocks=[
      document.querySelector('#salon-mobile #tn13Portfolio .tn22-port'),
      document.querySelector('#salon-mobile #tn13Services .tn31-services'),
      document.querySelector('#salon-mobile #tn38About .tn42-about'),
      document.querySelector('#salon-mobile #tn13Team .tn22-team'),
      document.querySelector('#salon-mobile #tn13Reviews .br-reviews'),
      document.querySelector('#salon-mobile #tn13Visit .tn22-visit')
    ].filter(Boolean);
    revealBlocks.forEach(el=>el.classList.add('tn54-reveal-block'));
    if('IntersectionObserver' in window && !window.matchMedia('(prefers-reduced-motion: reduce)').matches){
      const sectionReveal=new IntersectionObserver(entries=>{
        entries.forEach(entry=>{
          if(!entry.isIntersecting)return;
          entry.target.classList.add('tn54-visible');
          sectionReveal.unobserve(entry.target);
        });
      },{threshold:.08,rootMargin:'0px 0px -7% 0px'});
      revealBlocks.forEach(el=>sectionReveal.observe(el));
    }else{
      revealBlocks.forEach(el=>el.classList.add('tn54-visible'));
    }
...
(function(){
  ...
  const BRAND_SRC='logoglavnaya.jpg';
  ...
  function ensureStyle(){
    ...
    style.textContent=`
      @media(max-width:1023px){
        ...
        #salon-mobile .tn22-media .br-hero-video{
          position:absolute!important;
          inset:0!important;
          width:100%!important;
...
(function(){
  ...
  var rows=[
    ...
    ['ЕЛЕНЫ БАГДАСАРЯН','ԵԼԵՆԱ ԲԱՂԴԱՍԱՐՅԱՆ','ELENA BAGHDASARYAN'],
    ['Студия Колористики','Գունագետների ստուդիա','Color Studio'],
    ...
    ['Открыто до 20:00','Открыто до 20:00','Open until 20:00'],
    ['Закрыто до 10:00','Закрыто до 10:00','Closed until 10:00'],
    ['до 20:00','до 20:00','until 20:00'],
    ['до 10:00','до 10:00','until 10:00'],
    ['10:00–20:00','10:00–20:00','10:00–20:00'],
    ['10:00–20:00','10:00–20:00','10:00–20:00'],
  ...
  function applySpecials(){
    ...
    if(window.__fitSalonHeroTitle) requestAnimationFrame(window.__fitSalonHeroTitle);
    if(heroName) heroName.textContent=currentLang==='en'?'ELENA BAGHDASARYAN':'ЕЛЕНЫ БАГДАСАРЯН';
  ...
  function start(){
    ...
    var timer=setInterval(function(){
      ...
      root.addEventListener('br:status-updated',function(){
...
(function(){
  ...
  function applyStatus(){
    ...
    if(contactStatus){
      ...
      if(text)text.textContent=open?'Открыто до 20:00':'Закрыто до 10:00';
    }
    ...
    root.dispatchEvent(new Event('br:status-updated'));
  }
  applyStatus();
