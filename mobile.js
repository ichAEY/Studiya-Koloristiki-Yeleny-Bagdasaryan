...
function fitHeroTitle(){
  ...
  const target=Math.max(220,heroCardEl.clientWidth-64);
  ...
  fitLine(heroTitleEl,Math.min(26.5,Math.max(20,window.innerWidth*.066)),17);
  fitLine(heroSubEl,Math.min(15.5,Math.max(13.5,window.innerWidth*.0385)),12.5);
}
