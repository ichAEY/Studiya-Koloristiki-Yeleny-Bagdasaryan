...
(function(){
  ...
  if(!window.matchMedia || !window.matchMedia('(max-width:1023px)').matches || window.matchMedia('(min-width:768px) and (hover:hover) and (pointer:fine)').matches) return;
    ...
    @media(max-width:1023px){
      ...
      .tn22-title{margin:0!important;font:500 clamp(34px,9.4vw,42px)/.9 'Cormorant Garamond',Georgia,serif!important;letter-spacing:.035em!important;text-indent:.035em!important;text-transform:uppercase!important;white-space:nowrap!important}
...
/* Студия Колористики Елены Багдасарян multilingual interface — HY / RU / EN */
(function(){
  'use strict';
  if(!window.matchMedia || !window.matchMedia('(max-width:1023px)').matches || window.matchMedia('(min-width:768px) and (hover:hover) and (pointer:fine)').matches) return;
